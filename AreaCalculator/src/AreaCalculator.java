...
public class AreaCalculator extends JFrame {
    ...
    public AreaCalculator() {
        ...
        String[] arafat= {"Square", "Rectangle", "Triangle", "Circle", "Trapezoid", "Sector", "Octagon", "Ellipse", "Parallelogram"};
        shapeComboBox = new JComboBox(arafat);
        ...
        resultArea.setBounds(260, 50, 264, 80);
        ...
        getContentPane().add(majorAxisLabel);
        getContentPane().add(majorAxisField);
        getContentPane().add(minorAxisLabel);
        getContentPane().add(minorAxisField);
